...
# ADD LINK32 kernel32.lib user32.lib ws2_32.lib /nologo /dll /machine:I386 /out:"DLL_Release/ptypes.dll"
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=mkdir       ..\so\      	copy        DLL_Release\ptypes.lib        ..\so\       	copy        DLL_Release\ptypes.dll        ..\so\ 
...
# ADD LINK32 kernel32.lib user32.lib ws2_32.lib /nologo /dll /debug /machine:I386 /out:"DLL_Debug/ptypes.dll" /pdbtype:sept
